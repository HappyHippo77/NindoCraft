...
replaceitem entity @s hotbar.4 minecraft:clock{CustomModelData:7700023,display:{Name:"\"\""},NindoCraftID:0}
replaceitem entity @s hotbar.5 minecraft:clock{CustomModelData:7700022,display:{Name:"\"\""},NindoCraftID:0}
replaceitem entity @s hotbar.6 minecraft:clock{CustomModelData:7700025,display:{Name:"\"\""},NindoCraftID:0}
replaceitem entity @s hotbar.7 minecraft:clock{CustomModelData:7700025,display:{Name:"\"\""},NindoCraftID:0}
replaceitem entity @s hotbar.8 minecraft:clock{CustomModelData:7700024,display:{Name:"\"\""},NindoCraftID:0}
