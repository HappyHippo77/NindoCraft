...
execute if block ~ ~ ~ #du:flammable if block ~ ~1 ~ #du:air run setblock ~ ~1 ~ fire
execute if block ~ ~-1 ~ #du:flammable if block ~ ~ ~ #du:air run setblock ~ ~ ~ fire
execute if block ~ ~1 ~ #du:flammable if block ~ ~2 ~ #du:air run setblock ~ ~2 ~ fire
